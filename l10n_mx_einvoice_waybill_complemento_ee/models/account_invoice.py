...
class InvoiceComplementLocationCP(models.Model):
    ...
    def onchange_location_partner_id(self):
        if self.location_partner_id:
            ...
            self.location_station_id = self.location_partner_id.location_station_id.id
    ...
    """
    @api.onchange('tipo_transporte_code')
    def onchange_tipo_transporte_code(self):
        domain = {}
        if self.tipo_transporte_code=='03':
            domain['location_station_id'] = [('designer_iata','!=', False)]
        elif self.tipo_transporte_code=='04':
            domain['location_station_id'] = [('iron_line','!=', False)]
